...
pub fn caculate_tick_id(total_supply:u128,decimals:u8, from: &ScriptKey,to: &ScriptKey) -> TickId {
...
mod tests {
  ...
  fn test_serialize() {
    ...
    let addr2 = Address::from_str("bc1pgllnmtxs0g058qz7c6qgaqq4qknwrqj9z7rqn9e2dzhmcfmhlu4sfadf5e").unwrap();
    let tick_id = caculate_tick_id(100,18,&ScriptKey::from_address(addr1),&ScriptKey::from_address(addr2));
    println!("tick_id:{}",tick_id.hex());

    let addr1  = Address::from_str("bc1pgllnmtxs0g058qz7c6qgaqq4qknwrqj9z7rqn9e2dzhmcfmhlu4sfadf5e").unwrap();

    let addr2 = Address::from_str("bc1pgllnmtxs0g058qz7c6qgaqq4qknwrqj9z7rqn9e2dzhmcfmhlu4sfadf5e").unwrap();
    let tick_id = caculate_tick_id(10,18,&ScriptKey::from_address(addr1),&ScriptKey::from_address(addr2));
    println!("tick_id:{}",tick_id.hex());

    let addr1  = Address::from_str("bc1pgllnmtxs0g058qz7c6qgaqq4qknwrqj9z7rqn9e2dzhmcfmhlu4sfadf5e").unwrap();

    let addr2 = Address::from_str("bc1pgllnmtxs0g058qz7c6qgaqq4qknwrqj9z7rqn9e2dzhmcfmhlu4sfadf5e").unwrap();
    let tick_id = caculate_tick_id(100,1,&ScriptKey::from_address(addr1),&ScriptKey::from_address(addr2));
    println!("tick_id:{}",tick_id.hex());
  }
