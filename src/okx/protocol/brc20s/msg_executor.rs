...
pub fn execute<'a, M: BRC20DataStoreReadWrite, N: DataStoreReadWrite>(
  ...
  let event = match &msg.op {
    ...
    BRC20SOperation::PassiveUnStake(passive_unstake) => {
...
fn process_passive_unstake<'a, M: BRC20DataStoreReadWrite, N: DataStoreReadWrite>(
  ...
  for (pid, stake) in pids.iter() {
    ...
    passive_msg.op = BRC20SOperation::UnStake(stake_msg.clone());
...
mod tests {
  ...
  fn execute_for_test<'a, M: BRC20DataStoreReadWrite, N: DataStoreReadWrite>(
    ...
    let result = match msg.clone().op {
      ...
      BRC20SOperation::InscribeTransfer(inscribe_transfer) => {
  ...
  fn test_process_deploy() {
    ...
    let msg = mock_create_brc20s_message(
      script.clone(),
      script.clone(),
      BRC20SOperation::Deploy(deploy.clone()),
    );
    ...
    let msg = mock_create_brc20s_message(
      script.clone(),
      script.clone(),
      BRC20SOperation::Deploy(second_deply.clone()),
    );
    let context = BlockContext {
      blockheight: 20,
      blocktime: 1687245485,
  ...
  fn test_process_deploy_common() {
    ...
    //deploy second pool
    {
      ...
      let msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::Deploy(second_deploy.clone()),
      );
      let context = BlockContext {
        blockheight: 0,
        blocktime: 1687245485,
  ...
  fn test_process_error_params() {
    ...
    //err pool type
    {
      ...
      let msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::Deploy(err_pool_type.clone()),
      );
      let context = BlockContext {
        blockheight: 0,
        blocktime: 1687245485,
    ...
    //err pid
    {
      ...
      let msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::Deploy(err_pid.clone()),
      );
      let context = BlockContext {
        blockheight: 0,
        blocktime: 1687245485,
    ...
    //err stake,earn
    {
      ...
      let msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::Deploy(err_stake.clone()),
      );
      let context = BlockContext {
        blockheight: 0,
        blocktime: 1687245485,
      ...
      let msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::Deploy(err_earn.clone()),
      );
      let context = BlockContext {
        blockheight: 0,
        blocktime: 1687245485,
    ...
    // err erate
    {
      ...
      let msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::Deploy(err_erate.clone()),
      );
      let context = BlockContext {
        blockheight: 0,
        blocktime: 1687245485,
    ...
    //err dmax
    {
      ...
      let msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::Deploy(err_dmax.clone()),
      );
      let context = BlockContext {
        blockheight: 0,
        blocktime: 1687245485,
    ...
    //err total_supply
    {
      ...
      let msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::Deploy(err_total.clone()),
      );
      let context = BlockContext {
        blockheight: 0,
        blocktime: 1687245485,
  ...
  fn test_process_stake() {
    ...
    let msg = mock_create_brc20s_message(
      script.clone(),
      script.clone(),
      BRC20SOperation::Stake(stake_msg.clone()),
    );
    let context = BlockContext {
      blockheight: 20,
      blocktime: 1687245485,
    ...
    // MAX_STAKED_POOL_NUM 5
    {
      ...
      msg.op = BRC20SOperation::Deploy(deploy.clone());
      let result = process_deploy(
        context,
        &brc20_data_store,
        &brc20s_data_store,
      ...
      msg.op = BRC20SOperation::Stake(stake_msg.clone());
      let result = process_stake(
        context,
        &brc20_data_store,
        &brc20s_data_store,
  ...
  fn test_process_unstake() {
    ...
    assert_eq!(expect_userinfo, serde_json::to_string(&userinfo).unwrap());
    {
      ...
      let mut msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::UnStake(unstake_msg.clone()),
      );
      let context = BlockContext {
        blockheight: 30,
        blocktime: 1687245485,
  ...
  fn test_process_passive_unstake() {
    ...
    assert_eq!(expect_userinfo, serde_json::to_string(&userinfo).unwrap());
    {
      ...
      let mut msg = mock_create_brc20s_message(
        script.clone(),
        script.clone(),
        BRC20SOperation::PassiveUnStake(passive_unstake_msg.clone()),
      );
      let context = BlockContext {
        blockheight: 30,
        blocktime: 1687245485,
  ...
  fn test_process_deploy_most() {
...

    {
      ...
      msg.op = BRC20SOperation::Deploy(deploy);
      let result = execute_for_test(&brc20_data_store, &brc20s_data_store, &msg, 0);
      assert_eq!(
  ...
  fn test_mint() {
    ...
    let msg = mock_create_brc20s_message(
      script.clone(),
      script.clone(),
      BRC20SOperation::Mint(mint_msg.clone()),
    );
    let context = BlockContext {
      blockheight: 30,
      blocktime: 1687245485,
  ...
  fn test_transfer() {
    ...
    let msg = mock_create_brc20s_message(
      script.clone(),
      script.clone(),
      BRC20SOperation::InscribeTransfer(transfer_msg.clone()),
    );
    let context = BlockContext {
      blockheight: 200000,
      blocktime: 1687245485,
    ...
    let msg = mock_create_brc20s_message(
      script.clone(),
      script.clone(),
      BRC20SOperation::Transfer(transfer_msg.clone()),
    );
    let context = BlockContext {
      blockheight: 200000,
      blocktime: 1687245485,
