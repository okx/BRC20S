...
mod tests {
  ...
  fn test_pool_dmax() {
    ...
    do_one_case(
      ...
      0,
      true,
      13333333333333333300,
      100 * stake_base,
      300 * stake_base,
      40000000000000000000,
      Ok(13333333333333333300),
      Ok(()),
      STAKED_DECIMAL,
    );
    ...
    do_one_case(
      ...
      0,
      true,
      26666666666666666600,
      200 * stake_base,
      300 * stake_base,
      40000000000000000000,
      Ok(26666666666666666600),
      Ok(()),
      STAKED_DECIMAL,
    );
