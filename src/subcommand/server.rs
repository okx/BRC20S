  ...
  pub(crate) fn run(self, options: Options, index: Arc<Index>, handle: Handle) -> Result {
    Runtime::new()?.block_on(async {
      ...
      let api_v1_router = Router::new()
        ...
        .route("/brc20s/tick", get(brc20s_api::brc30_all_tick_info))
        .route("/brc20s/tick/:tick_id", get(brc20s_api::brc30_tick_info))
        .route(
          "/brc20s/debug/tick/:tick_id",
          get(brc20s_api::brc30_debug_tick_info),
        )
        .route("/brc20s/pool", get(brc20s_api::brc30_all_pool_info))
        .route("/brc20s/pool/:pid", get(brc20s_api::brc30_pool_info))
        .route(
          "/brc20s/debug/pool/:pid",
          get(brc20s_api::brc30_debug_pool_info),
        )
        .route(
          "/brc20s/debug/stake/:address/:tick",
          get(brc20s_api::brc30_debug_stake_info),
        )
        .route(
          "/brc20s/pool/:pid/address/:address/userinfo",
          get(brc20s_api::brc30_userinfo),
        )
        .route(
          "/brc20s/debug/pool/:pid/address/:address/reward",
          get(brc20s_api::brc30_user_pending_reward),
        )
        .route(
          "/brc20s/tick/:tick_id/address/:address/balance",
          get(brc20s_api::brc30_balance),
        )
        .route(
          "/brc20s/debug/pool/:pid/address/:address/userinfo",
          get(brc20s_api::brc30_debug_userinfo),
        )
        .route(
          "/brc20s/debug/tick/:tick_id/address/:address/balance",
          get(brc20s_api::brc30_debug_balance),
        )
        .route(
          "/brc20s/address/:address/balance",
          get(brc20s_api::brc30_all_balance),
        )
        .route(
          "/brc20s/tick/:tick_id/address/:address/transferable",
          get(brc20s_api::brc30_transferable),
        )
        .route(
          "/brc20s/address/:address/transferable",
          get(brc20s_api::brc30_all_transferable),
        )
        .route(
          "/brc20s/tx/:txid/receipts",
          get(brc20s_api::brc30_txid_receipts),
        )
        .route(
          "/brc20s/debug/tx/:txid/receipts",
          get(brc20s_api::brc30_debug_txid_receipts),
        )
        .route(
          "/brc20s/block/:blockhash/receipts",
          get(brc20s_api::brc30_block_receipts),
        )
        .route(
          "/brc20s/stake/:address/:tick",
          get(brc20s_api::brc30_stake_info),
        );
